...
- (void) addFiltersToQueue {
    ...
    // Chrome Filter - added for exercise - Simple Filter
    ...
    // Posterize and Blur - added for Exercise - Compound Filter
     ...
     [self.photoFilterOperationQueue addOperationWithBlock:^{
         ...
         if (posterizeFilter) {
             ...
             if (discBlur) {
                 [discBlur setValue:result forKeyPath:kCIInputImageKey];
                 result = discBlur.outputImage;
             }
             
            [self addCIImageToCollectionView:result withFilterTitle:NSLocalizedString(@"PosterBlur", @"Poster Filter")];
         }
     }];
